...
def train_one_epoch(args, model, optimizer, train_loader, epoch, criterion, total_loss_fn, 
    ...
    while True:
        ...
        #loss = total_loss_fn(seg_masks, norm_edge_masks, cluster_edge_masks, labels, labels, labels)
        ...
        # Debugging prints to check shapes before loss calculation
...
def main(args):
    ...
    global_metrics_dict["Loss/train"] = 10.0
    global_metrics_dict["Loss/test"] = average_test_loss
